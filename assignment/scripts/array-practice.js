...
let favoriteFoods = ['Lasagna', 'Caviar', 'Roast Chicken', 'Duck'];
...
console.log('My first food is', favoriteFoods[0]);

// 3.b. TODO: Log the last animal in the array using it's array index
console.log('My last food is', favoriteFoods[3]);
...
console.log('favorite food is now', favoriteFoods);
